...
def register_routes(app: Flask):
    """Регистрация всех маршрутов приложения с обработкой ошибок"""
    try:
        # Пытаемся импортировать все маршруты
        ...
        app.logger.error(f"Неожиданная ошибка при регистрации маршрутов: {e}")
        create_minimal_routes(app)
